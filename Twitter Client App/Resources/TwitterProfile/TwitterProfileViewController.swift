...
open class TwitterProfileViewController: UIViewController {
    ...
    open var descriptionString: String? {
        didSet {
            ...
            self.navigationDetailLabel.text = descriptionString
        }
    }
...
extension TwitterProfileViewController {
    ...
    internal func prepareViews() {
        ...
        _navigationDetailLabel.text = self.descriptionString ??  "{121 Tweets}"
    ...
    internal func computeStickyHeaderContainerViewFrame() -> CGRect {
        return CGRect(x: 0, y: 0, width: mainScrollView.bounds.width, height: stickyheaderContainerViewHeight)
    }
    
    internal func computeProfileHeaderViewFrame() -> CGRect {
    ...
    internal func computeTableViewFrame(tableView: UIScrollView) -> CGRect {
    ...
    internal func updateMainScrollViewFrame() {
...
extension TwitterProfileViewController {
    ...
    private func debugContentOffset(contentOffset: CGPoint) {
